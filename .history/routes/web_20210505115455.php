...
Route::post('/belongings/list_api', 'PracticeVueApiController@getAllMessage'); // メッセージ取得API
Route::post('/belongings/messeage_api',  'PracticeVueApiController@sendMessage');   // メッセージ送信API
